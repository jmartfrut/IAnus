@echo off
chcp 65001 > nul
title Gestor de Horarios GIM — UPCT (2026-2027)

cd /d "%~dp0"
set "GRADO_DIR=%~dp0"
set "ROOT_DIR=%~dp0..\.."
set "DB_NAME=horarios_2627.db"
set "TMP_DB=%TEMP%\horarios_gim_2627.db"

echo ----------------------------------------
echo  Gestor de Horarios GIM  (2026-2027)
echo  UPCT
echo ----------------------------------------
...
echo [INFO] Arrancando servidor de horarios GIM (2026-2027)...
